...
import { aiModel, aiModelGemini, aiPrompt, markAnalysisPrompt, maxTokens } from "../utils/utils.js";
...
const geminiModel = geminiAI.getGenerativeModel({ model: aiModelGemini });
