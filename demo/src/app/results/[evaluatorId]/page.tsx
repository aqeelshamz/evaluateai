...
import { FiBook, FiChevronLeft, FiEdit3, FiFileText, FiHelpCircle, FiInfo, FiKey, FiPlayCircle, FiPrinter, FiRotateCw, FiUser, FiUsers, FiZoomIn, FiZoomOut } from 'react-icons/fi';
